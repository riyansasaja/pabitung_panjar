...
<body>
    ...
    <form action="hasil.php" method="POST" class="mt-3">
        <input type="text" value="talak_murni" name="jenis" hidden>
        <div class="form-group">
            <label for="kelurahan">Pilih Kelurahan Tempat Tinggal Suami</label>
        ...
        <div class="form-group">
            <label for="kelurahan_dua">Pilih Kelurahan Tempat Tinggal Istri</label>
            <select class="form-control selectpicker" data-live-search="true" id="kelurahan_dua" name="kelurahan_dua">
                <option value="pilih" data-tokens="0">--Pilih Kelurahan--</option>
            </select>
        </div>
